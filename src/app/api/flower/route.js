...
// src/app/api/flower/route.js
import { query } from "../../../utils/database";
import { ine_flower_ModuleID, ine_flower_tablename } from "../../../utils/apiEndPoints";
...
// Table Name
const tableName = ine_flower_tablename;
...
export const DELETE = async (req) => {
    try {
        ...
        await Promise.all(deletedIds.map(async (deletedId) => {
            ...
            activityLog(ine_flower_ModuleID, currentRecord, null, 3, 0); // Maintain Activity Log
        }));
