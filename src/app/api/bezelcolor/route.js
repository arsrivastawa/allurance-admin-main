...
// src/app/api/bezelcolor/route.js
import { query } from "../../../utils/database";
import { ine_bezel_color_ModuleID, ine_bezel_color_tablename } from "../../../utils/apiEndPoints";
...
// Table Name
const tableName = ine_bezel_color_tablename;
...
export const DELETE = async (req) => {
    try {
        ...
        await Promise.all(deletedIds.map(async (deletedId) => {
            ...
            activityLog(ine_bezel_color_ModuleID, currentRecord, null, 3, 0); // Maintain Activity Log
        }));
