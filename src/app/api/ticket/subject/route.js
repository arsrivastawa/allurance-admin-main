...
import { ine_tickets_ModuleID, ine_ticket_subject_tablename } from "../../../../utils/apiEndPoints";
...
// Table Name
const tableName = ine_ticket_subject_tablename;
...
export const PUT = async (req) => {
    try {
        ...
        await query(`UPDATE ${tableName} SET title = ?, updated_at = NOW() WHERE id = ?`, [title, id]);
