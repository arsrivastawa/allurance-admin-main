...
import { ine_blog_category_ModuleID, ine_blog_category_tablename } from "../../../../utils/apiEndPoints";
...
// Table Name
const tableName = ine_blog_category_tablename;
...
export const POST = async (req) => {
    try {
        ...
        // Insertion
        const insertResult = await query(`INSERT INTO ${tableName} (name,created_by) VALUES (?,?)`, [
            requestData.name,
...
export const DELETE = async (req) => {
    try {
        ...
        await Promise.all(deletedIds.map(async (deletedId) => {
            ...
            activityLog(ine_blog_category_ModuleID, currentRecord, null, 3, 0); // Maintain Activity Log
        }));
