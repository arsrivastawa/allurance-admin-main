...
// src/app/api/colorshade/route.js
import { query } from "../../../utils/database";
import { ine_color_shade_ModuleID, ine_color_shade_tablename } from "../../../utils/apiEndPoints";
...
// Table Name
const tableName = ine_color_shade_tablename;
...
export const DELETE = async (req) => {
    try {
        ...
        await Promise.all(deletedIds.map(async (deletedId) => {
            ...
            activityLog(ine_color_shade_ModuleID, currentRecord, null, 3, 0); // Maintain Activity Log
        }));
