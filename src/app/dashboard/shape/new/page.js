"use client"
import { ProductCreateView } from 'src/sections/shape/view';
import React, { useEffect, useState } from 'react';
import { ine_shape_ModuleID } from 'src/utils/apiEndPoints';
...
export default function ProductListPage() {
  ...
  useEffect(() => {
    const moduleId = ine_shape_ModuleID; // Assuming you have a module ID
