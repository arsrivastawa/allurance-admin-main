...
import { ProductCreateView } from 'src/sections/innermaterial/view';
import { ine_inner_material_ModuleID } from 'src/utils/apiEndPoints';
...
export default function ProductListPage() {
  ...
  useEffect(() => {
    const moduleId = ine_inner_material_ModuleID; // Assuming you have a module ID
