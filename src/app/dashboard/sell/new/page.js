...
import { ine_sell_ModuleID } from 'src/utils/apiEndPoints';
import { ProductCreateView } from 'src/sections/sale/view';
...
export default function ProductListPage() {
  ...
  useEffect(() => {
    const moduleId = ine_sell_ModuleID; // Assuming you have a module ID
