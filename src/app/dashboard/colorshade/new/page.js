...
import { ProductCreateView } from 'src/sections/colorshade/view';
import { ine_color_shade_ModuleID } from 'src/utils/apiEndPoints';
...
export default function ProductListPage() {
  ...
  useEffect(() => {
    const moduleId = ine_color_shade_ModuleID; // Assuming you have a module ID
