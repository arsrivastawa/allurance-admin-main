"use client"
import { ProductListView } from 'src/sections/lookforcases/view';
import { useEffect, useState } from 'react';
import { ine_supportchannel_ModuleID } from 'src/utils/apiEndPoints';
...
export default function ProductListPage() {
  ...
  useEffect(() => {
    const moduleId = ine_supportchannel_ModuleID; // Assuming you have a module ID
