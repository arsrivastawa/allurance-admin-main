...
import { ProductCreateView } from 'src/sections/flower/view';
import { ine_flower_ModuleID } from 'src/utils/apiEndPoints';
...
export default function ProductListPage() {
  ...
  useEffect(() => {
    const moduleId = ine_flower_ModuleID; // Assuming you have a module ID
