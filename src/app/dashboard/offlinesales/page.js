...
import { ProductListView } from 'src/sections/offline_sales/view';
import { ine_offline_sales_ModuleID } from 'src/utils/apiEndPoints';
...
export default function ProductListPage() {
  ...
  useEffect(() => {
    const moduleId = ine_offline_sales_ModuleID; // Assuming you have a module ID
