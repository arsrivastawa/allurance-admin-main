...
import { ProductCreateView } from 'src/sections/mmasthead/view';
import { ine_mmasthead_ModuleID } from 'src/utils/apiEndPoints';
...
export default function ProductListPage() {
  ...
  useEffect(() => {
    const moduleId = ine_mmasthead_ModuleID; // Assuming you have a module ID
