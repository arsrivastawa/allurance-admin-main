...
import { ProductCreateView } from 'src/sections/dmasthead/view';
import { ine_dmasthead_ModuleID } from 'src/utils/apiEndPoints';
...
export default function ProductListPage() {
  ...
  useEffect(() => {
    const moduleId = ine_dmasthead_ModuleID; // Assuming you have a module ID
