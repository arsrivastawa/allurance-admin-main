...
import { ProductCreateView } from 'src/sections/resintype/view';
import { ine_resin_ModuleID } from 'src/utils/apiEndPoints';
...
export default function ProductListPage() {
  ...
  useEffect(() => {
    const moduleId = ine_resin_ModuleID; // Assuming you have a module ID
