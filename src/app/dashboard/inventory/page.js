...
import { ine_inventory_ModuleID } from 'src/utils/apiEndPoints';
import { ProductListView } from 'src/sections/inventory/view';
...
export default function ProductListPage() {
  ...
  useEffect(() => {
    const moduleId = ine_inventory_ModuleID; // Assuming you have a module ID
