...
import { ProductCreateView } from 'src/sections/role/view';
import { ine_roles_ModuleID } from 'src/utils/apiEndPoints';
...
export default function ProductListPage() {
  ...
  useEffect(() => {
    const moduleId = ine_roles_ModuleID; // Assuming you have a module ID
