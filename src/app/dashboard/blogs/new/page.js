...
import { ProductCreateView } from 'src/sections/blogs/view';
import { ine_blog_category_ModuleID } from 'src/utils/apiEndPoints';
...
export default function ProductListPage() {
  ...
  useEffect(() => {
    const moduleId = ine_blog_category_ModuleID; // Assuming you have a module ID
