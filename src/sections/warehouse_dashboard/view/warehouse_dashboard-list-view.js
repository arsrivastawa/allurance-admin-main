...
import {
  WAREHOUSE_DASHBOARD_CARD_DATA,
  WAREHOUSE_DASHBOARD_RECORDS,
} from '../../../utils/apiEndPoints';
import ProductTableFiltersResult from '../warehouse_dashboard-table-filters-result';
import {
  RenderCellShape,
...
} from '../warehouse_dashboard-table-row';
...
export default function ProductListView(permissions) {
  ...
  const getListingData = async () => {
    try {
      ...
      const response = await ManageAPIsDataWithHeader(WAREHOUSE_DASHBOARD_RECORDS, fetchMethod);
  ...
  const getCardData = async () => {
    try {
      ...
      const response = await ManageAPIsDataWithHeader(WAREHOUSE_DASHBOARD_CARD_DATA, fetchMethod);
