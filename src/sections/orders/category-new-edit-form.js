...
export default function ProductNewEditForm({ currentProduct }) {
  ...
  useEffect(() => {
    if (currentProduct) {
      setValue('image1', currentProduct ? categoriesBasePath + currentProduct.image1 : null);
      setValue('image2', currentProduct ? categoriesBasePath + currentProduct.image2 : null);
    }
