...
import {
  AFFILIATION_DASHBOARD_CARD_DATA,
  AFFILIATION_DASHBOARD_RECORDS,
} from '../../../utils/apiEndPoints';
import ProductTableFiltersResult from '../affiliation_dashboard-table-filters-result';
import {
  RenderCellShape,
...
} from '../affiliation_dashboard-table-row';
...
export default function ProductListView(permissions) {
  ...
  const getListingData = async () => {
    try {
      ...
      const response = await ManageAPIsDataWithHeader(AFFILIATION_DASHBOARD_RECORDS, fetchMethod);
  ...
  const getCardData = async () => {
    try {
      ...
      const response = await ManageAPIsDataWithHeader(AFFILIATION_DASHBOARD_CARD_DATA, fetchMethod);
  ...
  return (
    <>
      ...
      >
        <Typography variant="h3">Affiliation Dashboard</Typography>
