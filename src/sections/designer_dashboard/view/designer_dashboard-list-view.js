...
import ProductTableFiltersResult from '../designer_dashboard-table-filters-result';
import {
  RenderCellShape,
...
} from '../designer_dashboard-table-row';
...
export default function ProductListView(permissions) {
  ...
  const getListingData = async () => {
    try {
      ...
      const response = await ManageAPIsDataWithHeader(DESIGNER_DASHBOARD_RECORDS, fetchMethod);
  ...
  const getCardData = async () => {
    try {
      ...
      const response = await ManageAPIsDataWithHeader(DESIGNER_DASHBOARD_CARD_DATA, fetchMethod);
  ...
  return (
    <>
      ...
      >
        <Typography variant="h3">Designer Dashboard</Typography>
