...
export function RenderCellProductBatchNumber({ params }) {
  return (
    <Stack direction="row" alignItems="center" sx={{ py: 2, width: 1 }}>
...
RenderCellProductBatchNumber.propTypes = {
  params: PropTypes.shape({
    row: PropTypes.object,
  }),
};

export function RenderCellProductLocation({ params }) {
  return (
    <Stack direction="row" alignItems="center" sx={{ py: 2, width: 1 }}>
      ...
      <ListItemText
        disableTypography
        primary={
          params.row.created_by_first_name + "  " + params.row.created_by_last_name}
        secondary={
          <Box component="div" sx={{ typography: 'body2', color: 'text.disabled' }}>
            {params.row.category}
          </Box>
...
RenderCellProductLocation.propTypes = {
  params: PropTypes.shape({
    row: PropTypes.object,
  }),
};
