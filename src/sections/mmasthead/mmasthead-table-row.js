...
export function RenderCellProductCode({ params }) {
  ...
  var avatarSRC = params.row.image1 ? `${mastheadBasePath}/${params.row.image1}` : '';
  return (
    <Stack direction="row" alignItems="center" sx={{ py: 2, width: 1 }}>

      <Avatar
        alt={params.row.image1}
        src={avatarSRC}
        variant="rounded"
        sx={{ width: 100, height: 64, mr: 2 }}
      />
