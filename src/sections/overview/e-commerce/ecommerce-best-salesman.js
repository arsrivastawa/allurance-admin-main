...
export default function EcommerceBestSalesman({
  ...
  return (
    <Card {...other}>
      <CardHeader title={title} subheader={subheader} sx={{ mb: 3 }} style={{ float: 'left' }} />
      <Button variant="contained" color="warning" style={{ float: 'right', margin: '20px' }}>Add</Button>

      <TableContainer sx={{ overflow: 'unset' }} style={{ clear: 'both' }}>
        <Scrollbar>
