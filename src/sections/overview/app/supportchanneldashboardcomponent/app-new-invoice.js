  ...
  return (
    <>
      <TableRow>
        ...
        <TableCell>{row.ticket_status == 1 && 'Pending' || row.ticket_status == 2 && 'Open' || row.ticket_status == 3 && 'Closed'}</TableCell>

        <TableCell>{row.description}</TableCell>

        <TableCell>{row.user_type == 1 && 'Existing ' || row.user_type == 2 && 'New'}</TableCell>
