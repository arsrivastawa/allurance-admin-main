        ...
        <Grid container spacing={3}>
            ...
            <Grid xs={12} lg={12}>
                <AppNewInvoice
                    ...
                    tableData={tableData}
                    tableLabels={[
                        { id: 'id', label: 'Model number' },
                        { id: 'category', label: 'batch number' },
...
export default ReplicatorDashboard