...
import InvoiceTableRow from '../qualitycheck-table-row';
import InvoiceTableToolbar from '../qualitycheck-table-toolbar';
import InvoiceTableFiltersResult from '../qualitycheck-table-filters-result';
import { PACKERS_CARTONPACKING_ENDPOINT, PACKERS_BOXPACK_REPORT_ENDPOINT, PACKERS_GET_QUALITY_REPORT } from '../../../utils/apiEndPoints';
...
export default function ProductListView(permissions) {
  ...
  const PackersData = async () => {
    try {
      ...
      const apiUrl = PACKERS_GET_QUALITY_REPORT;
