...
import ProductTableFiltersResult from '../marketing_dashboard-table-filters-result';
import {
  RenderCellShape,
...
} from '../marketing_dashboard-table-row';
...
export default function ProductListView(permissions) {
  ...
  const getListingData = async () => {
    try {
      ...
      const response = await ManageAPIsDataWithHeader(MARKETING_DASHBOARD_RECORDS, fetchMethod);
  ...
  const getCardData = async () => {
    try {
      ...
      const response = await ManageAPIsDataWithHeader(MARKETING_DASHBOARD_CARD_DATA, fetchMethod);
  ...
  return (
    <>
      ...
      >
        <Typography variant="h3">Marketing Dashboard</Typography>
