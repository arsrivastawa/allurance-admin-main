...
import InvoiceToolbar from './manage_sales_report-toolbar';
              ...
              <Table>
                <TableHead>
                  <TableRow>
                    ...
                    <TableCell>Redemption Numbers </TableCell>
                    <TableCell>Redemptions Per Person </TableCell>
                    <TableCell>Discount( in % )</TableCell>
                    <TableCell>Minimunn Cart Price</TableCell>
                    <TableCell>Minimunn Cart Products</TableCell>
                ...
                <TableBody>
                  <TableRow>
                    {/* <TableCell>{ModuleData.id}</TableCell> */}
                    <TableCell>{ModuleData.campaign_name}</TableCell>
                    <TableCell>{fDate(ModuleData.start_date)}</TableCell>
                    <TableCell>{fDate(ModuleData.till_date)}</TableCell>
                    <TableCell>{ModuleData.number_of_redemptions}</TableCell>
                    <TableCell>{ModuleData.number_of_redemptions_single_user}</TableCell>
                    <TableCell>{ModuleData.discount_percentage}</TableCell>
                    <TableCell>{ModuleData.min_cart_value}</TableCell>
                    <TableCell>{ModuleData.min_cart_products}</TableCell>
                    ...
                    <TableCell>{ModuleData.coupon_code}</TableCell>
                    <TableCell>
                      <div style={{ display: 'flex', gap: '10px', alignItems: 'center' }}>
