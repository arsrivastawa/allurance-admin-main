...
import ProductNewEditForm from '../social-new-edit-form';
import { ManageAPIsData } from '../../../utils/commonFunction';
import { CATEGORY_ENDPOINT, SOCIALLINK_ENDPOINT } from '../../../utils/apiEndPoints';
  ...
  useEffect(() => {
    const fetchData = async () => {
      try {
        ...
        const apiUrl = `${SOCIALLINK_ENDPOINT}?id=${id}`;
