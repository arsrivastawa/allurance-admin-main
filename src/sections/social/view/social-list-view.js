...
import { CATEGORY_ENDPOINT, ine_category_ModuleID, SOCIALLINK_ENDPOINT } from '../../../utils/apiEndPoints';
import ProductTableFiltersResult from '../social-table-filters-result';
import {
  // RenderCellStock,
  // RenderCellPrice,
  RenderCellPublish,
...
export default function ProductListView(permissions) {
  ...
  const getListingData = async () => {
    try {
      ...
      const response = await ManageAPIsData(SOCIALLINK_ENDPOINT, 'GET');
  ...
  const handleEditRow = useCallback(
    (id) => {
      router.push(paths.dashboard.social.edit(id));
    },
    [router]
  );
      ...
      >
        <CustomBreadcrumbs
          ...
          links={[
            ...
            {
              name: 'Social Link',
              href: paths.dashboard.social.root,
            },
            { name: 'List' },
          ]}
          // action=
