...
export function RenderCellRecordStatus({ params }) {
...
RenderCellRecordStatus.propTypes = {
...
export function RenderCellProductgiftcards({ params }) {
  return (
    <Stack direction="row" alignItems="center" sx={{ py: 2, width: 1 }}>
      <ListItemText
        disableTypography
...
RenderCellProductamount.propTypes = {
  params: PropTypes.shape({
    row: PropTypes.object,
  }),
};
export function RenderCellProductamount({ params }) {
  return (
    <Stack direction="row" alignItems="center" sx={{ py: 2, width: 1 }}>
      <ListItemText
        disableTypography
