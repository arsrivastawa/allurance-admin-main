...
export default function InvoiceTableRow({
  ...
  const { sent, created_at, status, total_amount, order_id, invoice_id, last_name, first_name, phone, email, payment_by_customer } = row;
  ...
  return (
    <>
      <TableRow hover selected={selected}>
        ...
        <TableCell>{payment_by_customer + ' /-'}</TableCell>
