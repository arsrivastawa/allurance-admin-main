...
export function RenderCellProductBatch({ params }) {
  return (
    <Stack direction="row" alignItems="center" sx={{ py: 2, width: 1 }}>
...
RenderCellProductBatch.propTypes = {
  params: PropTypes.shape({
    row: PropTypes.object,
  }),
};
...
export function RenderCellProductQty({ params }) {
  return (
    <Stack direction="row" alignItems="center" sx={{ py: 2, width: 1 }}>
...
RenderCellProductQty.propTypes = {
  params: PropTypes.shape({
    row: PropTypes.object,
  }),
};
