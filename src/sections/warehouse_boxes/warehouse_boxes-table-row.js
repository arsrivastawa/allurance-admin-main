...
export function RenderCellStock({ params }) {
  return (
    <Stack sx={{ typography: 'caption', color: 'text.primary' }}>
      <ListItemText
        disableTypography
        primary={
          <Link
...
<ListItemText
  ...
  secondary={
    <Box sx={{ display: 'flex', flexDirection: 'column', color: 'text.disabled' }}>
      <Box component="div" sx={{ typography: 'body2' }}>{params.row.category}</Box>
    </Box>
  }
  sx={{ display: 'flex', flexDirection: 'column' }}
/>
