...
export function RenderCellCreatedend({ params }) {
  return (
    <ListItemText
...
export function RenderCellProductCode({ params , record_status}) {
  return (
    <Stack direction="row" alignItems="center" sx={{ py: 2, width: 1 }}>
      ...
      <ListItemText
        ...
        primary={
          ...
          ) : params.row.record_status === 2 ? (
            <Label variant="soft" color="success">Approved</Label>
          ) : params.row.record_status === 3 ? (
